...
import GeolocalizacionUsu from '../MyScreens/GeolocalizacionScreen/GeolocalizacionUs';
...
function AdministradorScreen(props) {
  return (
    ...
    <TouchableOpacity style={{ marginTop: 20, width: 200, height: 50, backgroundColor: '#84EB3D', padding: 10, alignItems: 'center', borderRadius: 5 }}
    onPress={() => props.navigation.navigate('Us. infractores')}>
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="Geolocalizacion" component={GeolocalizacionUsu} />
        <Stack.Screen name="Us. infractores" component={GeolocalizacionScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
